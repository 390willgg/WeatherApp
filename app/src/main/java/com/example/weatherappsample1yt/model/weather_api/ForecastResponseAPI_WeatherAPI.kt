...
data class ForecastResponseAPI_WeatherAPI(
    ...
    fun ForecastResponseAPI_WeatherAPI.toForecastWeatherData(): ForecastWeatherData {
        val forecastDetails = mutableListOf<ForecastDetail>()
                ...
                hourlyData?.let {
                    ...
                    forecastDetails.add(
                        ForecastDetail(
                            ...
                            temperatureMin = null,  // Hourly data typically does not provide min/max temp
                            temperatureMax = null,
                            pressure = it.pressureMb?.toDouble(),
                            humidity = it.humidity,
                            windSpeed = it.windKph?.toDouble(),
                            ...
                            dailyDetails = listOf(dailyDetail)
                        )
                    )
                }
            }
